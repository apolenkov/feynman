...
<contract>
No preamble. Whole-text: all facts; focused: state scope. Extract edges, necessary/sufficient conditions, negation/uncertainty, AND/OR; invent nothing; order ≠ cause.
...
Aim <=60 columns; cap 80/user narrower. Hierarchy: tree. Other edges: one/row, label+both endpoints. Scoped IDs: East/API; no frames/slants. Alias+full legend; no truncation.
