...
| REL-03 | `npm publish` completed for release version | PASS | Verified live versions via npm: `npm view @albinocrabs/feynman@0.2.2 version` returns `0.2.2`; release workflow includes publish guard |
...
- `CHANGELOG.md` is updated and `package.json` version is set to `0.2.4` with matching repository metadata.
